		...
		<div className="space-y-6">
			<div className="flex items-center justify-between">
				<div>
					...
					<p className="text-sm text-muted-foreground">Flights, hotels, cruises, transfers, excursions, car rentals, insurance, and more.</p>
				</div>
			...
			{segments.length === 0 ? (
				<p className="text-sm text-muted-foreground">No segments yet. Add the first one to start building this trip's itinerary.</p>
			) : (
