		...
		<div className="mx-auto max-w-3xl space-y-6">
					...
					<SupplierFormDialog
						...
						trigger={
							<Button variant="outline">
								...
								<LocaleText
									messageKey="suppliers.detail.edit"
									fallback="Edit"
								/>
							</Button>
						}
			...
			<Card>
				<CardHeader>
					<CardTitle>
						<LocaleText
							messageKey="suppliers.detail.contact"
							fallback="Contact"
						/>
					</CardTitle>
				</CardHeader>
				<CardContent>
					<dl className="grid grid-cols-1 gap-4 sm:grid-cols-2">
						...
						<Field
							label={
								<LocaleText
									messageKey="suppliers.detail.publicWebsite"
									fallback="Public website"
								/>
							}
							value={
								supplier.website ? (
						...
						<Field
							label={
								<LocaleText
									messageKey="suppliers.detail.agentPlatformUrl"
									fallback="Agent platform URL"
								/>
							}
							value={
					...
					{supplier.notes && (
						<div className="mt-4 border-t border-border pt-4">
							<dt className="text-xs font-medium uppercase tracking-wide text-muted-foreground">
								<LocaleText
									messageKey="suppliers.detail.notes"
									fallback="Notes"
								/>
							</dt>
			...
			<Card>
				<CardHeader>
					<CardTitle>
						<LocaleText
							messageKey="suppliers.detail.segments"
							fallback="Segments"
						/>
					</CardTitle>
				</CardHeader>
