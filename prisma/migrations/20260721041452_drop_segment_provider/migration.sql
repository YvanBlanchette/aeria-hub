...
INSERT INTO "new_TripSegment" ("confirmationNumber", "cost", "createdAt", "details", "endDateTime", "id", "location", "notes", "sortOrder", "startDateTime", "supplierId", "title", "tripId", "type", "updatedAt") SELECT "confirmationNumber", "cost", "createdAt", "details", "endDateTime", "id", "location", "notes", "sortOrder", "startDateTime", "supplierId", "title", "tripId", "type", "updatedAt" FROM "TripSegment";
