			...
			>
				<View style={styles.headerRow}>
					...
					<View style={styles.logoBlock}>
						<Image
							src={{ data: LOGO_BUFFER, format: "png" }}
							style={styles.logo}
						/>
				...
				{invoice.trip && (
					<Text style={styles.tripLine}>
						...
						{invoice.trip.startDate && invoice.trip.endDate ? ` (${formatDate(invoice.trip.startDate)} – ${formatDate(invoice.trip.endDate)})` : ""}
					</Text>
				)}
				...
				<Text style={styles.footer}>Thank you for booking with ÆRIA Voyages{invoice.trip ? ` · ${invoice.trip.name}` : ""}</Text>
			</Page>
		</Document>
	);
}
